...
class Calculadora(QMainWindow):
    def __init__(self,parent=None):
        ...
        self.setWindowTitle('Calculadora da Bagunça!')
        ...
        self.display.setStyleSheet(
            '* {background: #E0FFFF; color: #000; font-size: 30px;}'
        )
        ...
        self.add_btn(QPushButton('<=='),3,3,1,1,lambda: self.display.setText(self.display.text()[:-1]),style='background: #ffff99;')
        self.add_btn(QPushButton('='),3,4,1,1,self.eval_igual,style='background: #66ff99;')
        self.add_btn(QPushButton('1'),3,0,1,1)
        self.add_btn(QPushButton('2'),3,1,1,1)
        self.add_btn(QPushButton('3'),3,2,1,1)
        ...
        self.add_btn(QPushButton('Clear'),4,3,1,1,lambda: self.display.setText(''),'background: #ff9999;')
